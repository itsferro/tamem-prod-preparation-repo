...
import { BlockManagmentContentComponent } from './development/block-managment/content/content.component'
...
export const COURSE_ROUTES: Route[] = [
  ...
  {
    path: 'block/:blockId/content',
    component: BlockManagmentContentComponent,
    data: { title: 'Block Content Manager' },
  },
