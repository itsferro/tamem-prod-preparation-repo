...
export class LessonBlockTaskTrackComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(this.currentTask)
    {
      this.canvaLink = this.currentTask.canvaLink;
      this.googleDriveLink = this.currentTask.googleDriveLink;
      this.storyBoardLink = this.currentTask.storyBoardLink;
      this.hasStoryBoard = this.currentTask.hasStoryBoard;
      this.courseName = this.currentTask.courseName;
      this.lessonName = this.currentTask.lessonName;
      this.blockName = this.currentTask.blockName;
