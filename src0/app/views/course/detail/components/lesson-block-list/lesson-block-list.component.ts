...
@Component({
  selector: 'detail-lesson-block-list',
  standalone: true,
  imports: [CommonModule, NgbPaginationModule],
  templateUrl: './lesson-block-list.component.html',
  styleUrl: './lesson-block-list.component.scss'
})
export class LessonBlockListComponent implements OnInit, OnDestroy {
  @Input() lesson: any;
